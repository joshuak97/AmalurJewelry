...
include('../config/consulSQL.php');
 ...
 <span title='eliminar' ".'class="btn btn-warning btn-circle" '." value='".$_SESSION['tablaProducto'][$i]."' onclick='editarElemento(\"".$_SESSION['tablaProducto'][$i]."\",$i)' >
