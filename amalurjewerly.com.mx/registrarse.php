  ...
  <div id="wrapper">
    ...
    <main id="main" role="main">
      ...
      <section class="banner" style="background-image: url(images/AmalurJewerly/bgAmalur.jpg);">
        ...
        <div class="container">
          <div class="row">
            <div class="col-xs-12">
                <div class="caption">
                  <h1 class="main-heading heading-1">Registrate</h1>
      ...
      <section class="form-sec" id="form-login">
        ...
        <form action="process/registrar_usuario.php<?php if(isset($_GET['shop'])){echo "?shop=shop";}?>" method="post" class="contact-form">
          <fieldset>
            ...
            <div class="form-group">
              <input type="text" name="user" class="form-control" placeholder="Ingrese su nombre de usuario" required>
            </div>
            <div class="form-group">
              <input type="email" name="correo" class="form-control" placeholder="Correo electronico" required>
            </div>
            <div class="form-group">
              <input type="number" name="telefono" class="form-control" placeholder="Ingrese su numero de telefono" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              <input type="password" class="form-control" name="confirm-password" placeholder="Confirmar nueva contraseña" required>
            </div>
            <div class="form-group">
            
              <button class="btn-primary btn-login" type="submit">Registrate</button>
            </div>
