  ...
  <div id="wrapper">
    ...
    <main id="main" role="main">
      ...
      <section class="form-sec" id="form-login">
        ...
        <form action="process/login.php<?php if(isset($_GET['shop'])){echo "?shop=shop";}?>" method="post" class="contact-form">
          <fieldset>
            <div class="form-group">
              <input type="text" name="user" class="form-control" placeholder="Usuario o correo electronico">
            </div>
            <div class="form-group">
