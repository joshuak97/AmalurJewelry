...
$(document).ready(function() {
    ...
    function editar_categoria(id_categoria,nombre_categoria,descripcion){
...
$(document).ready(function(){
    ...
    var fieldHTML = '<div class="form-group"><label>Producto:</label> <input type="text"  class="form-control" placeholder="Codigo del producto" name="codigo[]" value=""/><input type="text" placeholder="Descripcion del producto" class="form-control"name="descripcion[]" value=""/><input type="number"  class="form-control" placeholder="Existencias" name="stock[]" value=""/><input type="file"  class="form-control"name="img[]" value=""/></div>'; //New input field html 
   ...
   /* $('#modal_editar_producto form').submit(function(e) {
    ...
    //Evento que permite aplicar descuento a los productos: 
    
    function aplicar_descuento(componente){
    var valor=componente.value;
    $.post("controlador/productos/select_descuento.php", {valor:valor} ,function(data){
     $("#descuento").html(data);
     });    
    }
    
    function aplicar_descuento2(componente){
    var valor=componente.value;
    $.post("controlador/productos/select_descuento.php", {valor:valor} ,function(data){
     $("#descuento2").html(data);
     });    
    }
...
//Funcion que despliega el modal de detalles del pedido.
 function detalles_pedido(id_pedido){
  $.post("controlador/pedidos/detalles_pedido.php",{ id_pedido:id_pedido }, function(data){
$("#tabla_detalles_pedido").html(data);
});
