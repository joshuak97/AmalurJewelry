...
$consul_proveedores=  ejecutarSQL::consultar("SELECT * FROM categoria_prod WHERE nombre_categoria='".$nombre_categoria."'");
...
if(consultasSQL::InsertSQL("categoria_prod", "nombre_categoria,descripcion", "'$nombre_categoria','$descripcion'")){
