 <!-- Sidebar -->
    <ul class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion" id="accordionSidebar" style="background-image:linear-gradient( 
180deg,#FFB6C1 10%,#eaecf4 100%);">
      ...
      <!-- Heading -->
      <div class="sidebar-heading" style="color:gray;">
        Administración
      </div>
...
-->
    ...
    <!--  <li class="nav-item"  onclick="cargarVistas('sucursales');">
      ...
      <li class="nav-item"  onclick="cargarVistas('inventario');">
        <a href="#" class="nav-link" href="charts.html" style="color:black;">
...
<!--      <div class="sidebar-heading">
    ...
    <!--  <li class="nav-item"  onclick="cargarVistas('clientes');">
     ...
     <div class="text-center d-none d-md-inline">
        <button class="rounded-circle border-0" id="sidebarToggle" style="color:gray"></button>
      </div>
