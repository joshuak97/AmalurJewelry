              ...
              <div class="table-responsive" id="tabla_categorias">
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    <?php
                    $count=1;
                 $consul_categorias=  ejecutarSQL::consultar("SELECT * FROM categoria_prod");
                 while ($categorias=mysqli_fetch_array($consul_categorias)){
                 echo "<tr>
                 <td>".$count."</td>
                 <td>".$categorias['nombre_categoria']."</td>
                  <td>".$categorias['descripcion']."</td><td>";
                 $count++;
                 ?>
                  <button class='btn btn-sm btn-warning' onclick="editar_categoria(<?php echo $categorias['id_categoria'].",'".$categorias['nombre_categoria']."','".$categorias['descripcion']."'";?>);"><span class='fa fa-edit'></span></button>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content"> 
     ...
     <form action="controlador/categorias/agregar_categoria.php" method="post" id="form_agregar_categoria">
      ...
      <div class="form-group"> 
      <input type="text" name="descripcion" class="form-control" placeholder="Descripcion categoria" required="">
      </div>      
      </div><!--End body-->
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content"> 
     ...
     <form action="controlador/categorias/editar_categoria.php" method="post" id="form_editar_categoria">
      ...
      <div class="form-group"> 
      <input type="text" name="nombre_categoria" id="nombre_categoria" class="form-control" placeholder="Nombre de la categoria" required="">
      </div>
      <div class="form-group"> 
      <input type="text" name="descripcion" id="descripcion" class="form-control" placeholder="Descripcion de la categoria" required="">
      </div>      
      </div><!--End body-->
  ...
  <div class="modal fade" id="modal_eliminar_categoria" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      ...
      <form action="controlador/categorias/eliminar_categoria.php" method="post">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">¿Desea eliminar a esta categoria?</h5>
