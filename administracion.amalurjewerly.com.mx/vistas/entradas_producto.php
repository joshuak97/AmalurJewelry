            ...
            <div class="card-body">
              ...
              <div class="table-responsive" id="tabla_productos">
                ...
                <table class="table table-bordered text-center" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
                 <?php
                 $consul_productos=  ejecutarSQL::consultar("SELECT * FROM entrada_producto inner join entrada on entrada.id_entrada=entrada_producto.id_entrada inner join producto on entrada_producto.id_producto=producto.id_producto order by id_ep desc");
