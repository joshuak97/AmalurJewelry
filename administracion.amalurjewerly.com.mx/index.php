...
<body class="" style="background-color:#e3e6f0;height:-webkit-fill-available;">
<div>
              ...
              <img src="./img/logo.png" style="width: 70%">
                ...
                <div style="padding:2% 10% 5% 10%;">
                  ...
                  <form class="user" action="process/login.php" method="post" id="login-form">
                    ...
                    <button type="submit" id="acceder" style="background-color:#4e73df6b;border-color: #dddfeb;" class="btn btn-success btn-user btn-block">
                      Login
                     </button>
                    </form>
